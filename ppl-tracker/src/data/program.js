...
// Exercise alternatives — same primary muscles, different equipment/angle
export const ALTERNATIVES = {
  'incline-db-press':       ['flat-db-press', 'cable-chest-fly', 'cable-crossover', 'pec-deck'],
  'machine-shoulder-press': ['cable-lateral-raise', 'machine-lateral-raise'],
  'cable-chest-fly':        ['pec-deck', 'cable-crossover', 'incline-db-press'],
  'cable-lateral-raise':    ['machine-lateral-raise'],
  'rope-pushdown':          ['overhead-tricep-ext', 'single-arm-pushdown', 'ez-skull-crusher'],
  'overhead-tricep-ext':    ['rope-pushdown', 'ez-skull-crusher', 'single-arm-pushdown'],
  'flat-db-press':          ['incline-db-press', 'pec-deck', 'cable-chest-fly'],
  'ez-skull-crusher':       ['rope-pushdown', 'overhead-tricep-ext', 'jm-press'],
  'pec-deck':               ['cable-chest-fly', 'cable-crossover', 'incline-db-press'],
  'cable-crossover':        ['cable-chest-fly', 'pec-deck', 'incline-db-press'],
  'machine-lateral-raise':  ['cable-lateral-raise'],
  'single-arm-pushdown':    ['rope-pushdown', 'overhead-tricep-ext'],
  'lat-pulldown-neutral':   ['wide-lat-pulldown', 'seated-cable-row', 'single-arm-row'],
  'seated-cable-row':       ['chest-supported-row', 'single-arm-row', 'lat-pulldown-neutral'],
  'chest-supported-row':    ['seated-cable-row', 'single-arm-row'],
  'face-pulls':             ['reverse-pec-deck'],
  'hammer-curls':           ['cable-curl', 'incline-db-curl', 'machine-preacher-curl'],
  'cable-curl':             ['hammer-curls', 'incline-db-curl', 'machine-preacher-curl'],
  'wide-lat-pulldown':      ['lat-pulldown-neutral', 'seated-cable-row'],
  'single-arm-row':         ['chest-supported-row', 'seated-cable-row'],
  'straight-arm-pulldown':  ['lat-pulldown-neutral', 'cable-pullover'],
  'reverse-pec-deck':       ['face-pulls'],
  'incline-db-curl':        ['cable-curl', 'hammer-curls', 'machine-preacher-curl'],
  'machine-preacher-curl':  ['incline-db-curl', 'cable-curl'],
  'belt-squat':             ['leg-press-high', 'leg-extension'],
  'leg-press-high':         ['belt-squat', 'leg-extension'],
  'leg-extension':          ['belt-squat', 'leg-press-high'],
  'seated-leg-curl':        ['lying-leg-curl', 'rdl-b'],
  'barbell-hip-thrust':     ['rdl-b', 'box-step-up'],
  'rdl-b':                  ['barbell-hip-thrust', 'seated-leg-curl', 'lying-leg-curl'],
  'box-step-up':            ['belt-squat', 'leg-press-high'],
  'lying-leg-curl':         ['seated-leg-curl', 'rdl-b'],
}
