...
const ProgramContext = createContext<{
  ...
  loading: boolean
  reload: () => void
  updateLastCompleted: (slug: any) => void
  programId: any
  morningWorkoutId: any
}>({
  programData: null,
  loading: true,
  reload: () => {},
...
function buildProgramShape(workouts: any, programDays: any, morningWorkoutId: any): Record<string, any> {
  const PROGRAM = {}
  const PROGRAM_ORDER = []
  const EXERCISES = {}
  const TAG_LABELS = {
...
export function ActiveProgramProvider({
  children, initialProgramRows = null }: { children: React.ReactNode, initialProgramRows?: any }) {
