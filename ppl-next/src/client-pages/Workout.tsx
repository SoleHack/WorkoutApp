...
export default function Workout() {
  ...
  const completedSets = (Object.values(sets) as any[]).reduce((acc: number, exSets: any) =>
        ...
        {!showExSearch ? (
          ...
          <div className={styles.exSearchWrap}>
            ...
            <div className={styles.exSearchResults}>
              {(Object.entries(EXERCISES) as [string, any][])
                .filter(([slug, ex]) =>
              ...
              {(Object.entries(EXERCISES) as [string, any][]).filter(([slug, ex]) =>
                ex.name.toLowerCase().includes(exSearchQuery.toLowerCase())
              ).length === 0 && (
